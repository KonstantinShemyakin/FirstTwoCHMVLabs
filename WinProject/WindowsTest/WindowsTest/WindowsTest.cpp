...
WCHAR szTitle[MAX_LOADSTRING] = _T("MY FIRST FUCKING WINDOW");                  // Текст строки заголовка
WCHAR szWindowClass[MAX_LOADSTRING] = _T("MainWindow");            // имя класса главного окна
